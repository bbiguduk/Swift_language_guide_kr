...
![Barcode UPC](/Users/a156618/Desktop/Boram/Google/Documents/Boram_Docs/Swift/08_barcode_UPC_2x.png)

다른 제품은 어떠한 ISO 8859-1 문자도 사용할 수 있고 2,953개의 문자까지 인코딩할 수 있는 QR 코드 형식의 2D 바코드 라벨이 부착되어 있습니다:

![Barcode QR](/Users/a156618/Desktop/Boram/Google/Documents/Boram_Docs/Swift/08_barcode_QR_2x.png)
...
> NOTE
> 원시값 초기화는 모든 원시값을 열거형 케이스로 반환할 수 없으므로 초기화가 실패할 수 있습니다. 더 자세한 내용은 [실패가능한 초기화 (Failable Initializers)](https://docs.swift.org/swift-book/ReferenceManual/Declarations.html#ID376) 을 참고 바랍니다.
